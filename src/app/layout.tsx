...
export const metadata: Metadata = {
  title: "Reparación de Televisores LG Madrid | Yireh Service",  description: "Técnico profesional en reparación de televisores LG en Madrid. 4.7★ (209 reseñas). Garantía 12 meses. Llamar: +34 615 652 022",  keywords: "reparación televisores LG Madrid, servicio técnico TV LG, reparación pantalla televisión, técnico electrodomésticos Madrid",  metadataBase: new URL("https://yirehservice.es"),
  alternates: {
    canonical: "https://yirehservice.es"},
  openGraph: {
    title: "Reparación de Televisores LG en Madrid - Yireh Service",    description: "Expertos en reparación de televisores LG. Diagnóstico gratuito, piezas originales, garantía 12 meses. ¡Llamanos hoy!",    url: "https://yirehservice.es",    siteName: "Yireh Service",    type: "website",    images: [
      {
        url: "https://yirehservice.es/og-image.jpg",        alt: "Servicio técnico de reparación LG TV Madrid"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Reparación LG TV en Madrid",    description: "Técnicos certificados, garantía 12 meses, 4.7★ de 209 clientes. Llamar: +34 615 652 022",    images: ["https://yirehservice.es/twitter-image.jpg"],
  },
  robots: {
    index: true,
    follow: true,
